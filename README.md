...
[![Open in Visual Studio Code](https://img.shields.io/static/v1?logo=visualstudiocode&label=&message=Open%20in%20Visual%20Studio%20Code&labelColor=2c2c32&color=007acc&logoColor=007acc)](https://open.vscode.dev/garyzjq/vscode-restclient) [![Marketplace Version](https://img.shields.io/visual-studio-marketplace/v/RESTClientPro.rest-client-internal)](https://marketplace.visualstudio.com/items?itemName=RESTClientPro.rest-client-internal) [![Downloads](https://img.shields.io/visual-studio-marketplace/d/RESTClientPro.rest-client-internal)](https://marketplace.visualstudio.com/items?itemName=RESTClientPro.rest-client-internal) [![Installs](https://img.shields.io/visual-studio-marketplace/i/RESTClientPro.rest-client-internal)](https://marketplace.visualstudio.com/items?itemName=RESTClientPro.rest-client-internal) [![Rating](https://img.shields.io/visual-studio-marketplace/r/RESTClientPro.rest-client-internal)](https://marketplace.visualstudio.com/items?itemName=RESTClientPro.rest-client-internal)
...
## Making Request
![rest-client](https://raw.githubusercontent.com/garyzjq/vscode-restclient/master/images/usage.gif)
### Request Line
...
## Making cURL Request
![cURL Request](https://raw.githubusercontent.com/garyzjq/vscode-restclient/master/images/curl-request.png)
...
## Request History
![request-history](https://raw.githubusercontent.com/garyzjq/vscode-restclient/master/images/request-history.png)
...
## Save Full Response
![Save Response](https://raw.githubusercontent.com/garyzjq/vscode-restclient/master/images/response.gif)
...
![Generate Code Snippet](https://raw.githubusercontent.com/garyzjq/vscode-restclient/master/images/code-snippet.gif)
...
![HTTP Language](https://raw.githubusercontent.com/garyzjq/vscode-restclient/master/images/http.png)
### Auto Completion
...
![Goto Symbols](https://raw.githubusercontent.com/garyzjq/vscode-restclient/master/images/navigate.png)
...
```
> More details about `aadToken` (Azure Active Directory Token) can be found on [Wiki](https://github.com/garyzjq/vscode-restclient/wiki/Azure-Active-Directory-Authentication-Samples)
...
## Special Thanks
All the amazing [contributors](https://github.com/garyzjq/vscode-restclient/graphs/contributors)❤️

## Feedback
Please provide feedback through the [GitHub Issue](https://github.com/garyzjq/vscode-restclient/issues) system, or fork the repository and submit PR.
